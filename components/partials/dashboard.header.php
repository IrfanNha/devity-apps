...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="index.php"><?php echo substr(APP_NAME, 0, 20); ?> </a>
    ...
    <nav id="sidebarMenu" class="col-sm-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item  mt-2 mt-lg-3">
            <a href="index.php" class="nav-link mx-2  <?php echo isset($pages) && strtolower($pages) === 'dashboard' ? 'bg-dark text-light rounded-1' : ''; ?>">
              <span class="me-2">
          ...
          <li class="nav-item">
            <a href="tambah-menu.php" class="nav-link mx-2  <?php echo isset($pages) && strtolower($pages) === 'tambah menu' ? 'bg-dark text-light rounded-1' : ''; ?>">
              <span class="me-2">
          ...
          <li class="nav-item">
            <a href="items.php" class="nav-link mx-2  <?php echo isset($pages) && strtolower($pages) === 'items' ? 'bg-dark text-light rounded-1' : ''; ?>">
              <span class="me-2">
          ...
          <li class="nav-item">
            <a href="item-stock.php" class="nav-link mx-2  <?php echo isset($pages) && strtolower($pages) === 'item stock' ? 'bg-dark text-light rounded-1' : ''; ?>">
              <span class="me-2">
          ...
          <ul class="nav flex-column mb-5">
            ...
            <li class="nav-item">
              <a class="nav-link  mx-2  <?php echo isset($pages) && strtolower($pages) === 'user profile' ? 'bg-dark text-light rounded-1' : ''; ?>" href="profiles.php">
                <span class="me-2">
            ...
            <li class="nav-item">
              <a class="nav-link  mx-2  <?php echo isset($pages) && strtolower($pages) === 'preferences' ? 'bg-dark text-light rounded-1' : ''; ?>" href="preferences.php">
                <span class="me-2">
